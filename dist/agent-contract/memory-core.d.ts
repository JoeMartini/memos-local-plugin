 ...
 */
import type { AgentKind, ApiLogDTO, EpochMs, EpisodeId, EpisodeListItemDTO, FeedbackDTO, PolicyDTO, RetrievalQueryDTO, RetrievalResultDTO, SessionId, SkillDTO, SkillId, SubagentOutcomeDTO, ToolOutcomeDTO, TraceDTO, TurnInputDTO, TurnResultDTO, WorldModelDTO, RuntimeNamespace, ShareScope } from "./dto.js";
...
export interface CoreHealth {
     ...
     */
    skillEvolver: ModelHealth & {
        inherited: boolean;
    };
}
export type BridgeHealthStatus = "connected" | "reconnecting" | "disconnected" | "unknown";
...
export interface EmbeddingMaintenanceStats {
    ...
    dimMismatch: number;
    needsRepair: number;
    byKind: Record<"trace" | "policy" | "world_model" | "skill", {
        totalSlots: number;
        ready: number;
        missing: number;
        dimMismatch: number;
...
export interface MemoryCore {
    ...
    onTurnEnd(result: TurnResultDTO): Promise<{
        traceId: string;
        episodeId: EpisodeId;
    }>;
    /** Called when the user gives task-level feedback (or implicit signals fire). */
    submitFeedback(feedback: Omit<FeedbackDTO, "id" | "ts"> & {
        ts?: number;
    }): Promise<FeedbackDTO>;
    /**
     ...
     */
    recordSubagentOutcome(outcome: SubagentOutcomeDTO): Promise<{
        traceId: string;
        episodeId: EpisodeId;
    }>;
     ...
     */
    deleteTraces(ids: readonly string[]): Promise<{
        deleted: number;
    }>;
    /**
     ...
     */
    shareTrace(id: string, share: {
        scope: ShareScope | null;
        target?: string | null;
        sharedAt?: number | null;
    }): Promise<TraceDTO | null>;
    getPolicy(id: string, namespace?: RuntimeNamespace, opts?: {
        includeAllNamespaces?: boolean;
    }): Promise<PolicyDTO | null>;
    getWorldModel(id: string, namespace?: RuntimeNamespace, opts?: {
        includeAllNamespaces?: boolean;
    ...
    setPolicyStatus(id: string, status: PolicyDTO["status"]): Promise<PolicyDTO | null>;
     ...
     * unknown.
     */
    editPolicyGuidance(id: string, patch: {
        preference?: string[];
        antiPattern?: string[];
    }): Promise<PolicyDTO | null>;
    /** Hard-delete a world-model row. */
    deleteWorldModel(id: string): Promise<{
        deleted: boolean;
    }>;
    /**
     ...
     * {@link shareTrace}.
     */
    shareWorldModel(id: string, share: {
        scope: ShareScope | null;
        target?: string | null;
        sharedAt?: number | null;
    }): Promise<WorldModelDTO | null>;
     ...
     */
    updateWorldModel(id: string, patch: {
        title?: string;
        body?: string;
        status?: "active" | "archived";
    }): Promise<WorldModelDTO | null>;
     ...
     */
    deleteSkill(id: SkillId): Promise<{
        deleted: boolean;
    }>;
    /**
