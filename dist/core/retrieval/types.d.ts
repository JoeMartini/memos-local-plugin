 ...
 */
export type RetrievalChannel = "vec_summary" | "vec_action" | "vec" | "fts" | "pattern" | "structural";
...
export interface RetrievalStats {
    ...
    topRelevance?: number;
    rankedCount?: number;
    llmFilterOutcome?: "disabled" | "no_llm" | "below_threshold" | "empty_query" | "skipped_by_scheduler" | "deferred_to_final" | "llm_kept_all" | "llm_filtered" | "llm_failed_safe_cutoff";
     ...
     * fragile).
     */
    channelHits?: Partial<Record<"vec_summary" | "vec_action" | "vec" | "fts" | "pattern" | "structural", number>>;
