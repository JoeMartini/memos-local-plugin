...
export declare function languageSteeringLine(lang: PromptLanguage): string;
/**
 ...
 */
export declare function detectDominantLanguage(samples: ReadonlyArray<string | null | undefined>, opts?: {
    zhRatioThreshold?: number;
}): PromptLanguage;
