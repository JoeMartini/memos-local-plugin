...
const NumberInRange = (def, min, max) => Type.Number({ default: def, ...(min != null ? { minimum: min } : {}), ...(max != null ? { maximum: max } : {}) });
// ─── Sub-schemas ────────────────────────────────────────────────────────────
...
const AlgorithmSchema = Type.Object({
    ...
    skill: Type.Object({
         ...
         */
        outputLanguageMode: Type.Union([Type.Literal("follow_policy"), Type.Literal("zh"), Type.Literal("en")], { default: "follow_policy" }),
