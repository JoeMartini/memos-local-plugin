...
import { createSessionManager, createEpisodeManager, createSessionEventBus, createIntentClassifier, createRelationClassifier, adaptSessionsRepo, adaptEpisodesRepo, } from "../session/index.js";
import { createCaptureEventBus, createCaptureRunner, attachCaptureSubscriber, } from "../capture/index.js";
import { createRewardEventBus, createRewardRunner, attachRewardSubscriber, } from "../reward/index.js";
import { attachL2Subscriber, createL2EventBus, } from "../memory/l2/index.js";
import { attachL3Subscriber, createL3EventBus, } from "../memory/l3/index.js";
import { attachSkillSubscriber, createSkillEventBus, } from "../skill/index.js";
import { attachFeedbackSubscriber, createFeedbackEventBus, } from "../feedback/index.js";
 ...
 */
export function extractAlgorithmConfig(deps) {
...
// ─── Bus wiring ───────────────────────────────────────────────────────────
export function buildPipelineBuses() {
    return {
...
export function buildPipelineSubscribers(deps, buses, algorithm, session) {
...
export function buildPipelineSession(deps, bus) {
...
// ─── Retrieval deps ───────────────────────────────────────────────────────
export function buildRetrievalDeps(deps, algorithm) {
    const embedder = deps.embedder;
    return {
        repos: wrapRetrievalRepos(deps.repos, deps.namespace),
        embedder: embedder
            ? {
                embed: (text, role) => embedder.embedOne({ text, role: role ?? "query" }),
            }
            : {
...
// ─── Log helpers ──────────────────────────────────────────────────────────
export function pipelineLogger(deps) {
